        ...
        def _run() -> Container:
            ...
            try:
                return client.containers.run(
                    ...
                    # that need to reach host services (e.g. android-automation
                    # connecting to the host ADB server) can resolve it without
                    # any extra config. Harmless for other templates.
